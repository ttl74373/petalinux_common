...
#
# project_tcl.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Sun Feb 01 15:01:28 EST 2026
...
set_property -name "platform.name" -value "myplatform" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  set som240_1_connector_pmod1_gpio [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 som240_1_connector_pmod1_gpio ]
...
\
  ...
  set_property -dict [list \
    CONFIG.GPIO_BOARD_INTERFACE {som240_1_connector_pmod1_gpio} \
    CONFIG.USE_BOARD_FLOW {true} \
  ] $axi_gpio_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports som240_1_connector_pmod1_gpio] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.492072",
   "Default View_TopLeft":"-175,-213",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port som240_1_connector_pmod1_gpio -pg 1 -lvl 5 -x 1560 -y 390 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 600 -y 110 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 130 -y 460 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 600 -y 430 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -x 1430 -y 390 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 1140 -y 90 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 4 -x 1430 -y 130 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -x 1140 -y 250 -defaultsOSRD
preplace netloc axi_intc_0_irq 1 1 4 260 210 1000J 190 1270J 220 1540
preplace netloc clk_wiz_0_clk_out1 1 1 3 250 220 990 180 1300
preplace netloc clk_wiz_0_locked 1 1 1 N 470
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 2 1010 310 1310
preplace netloc xlconstant_0_dout 1 3 1 1320J 160n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 230 NJ 230 940
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 3 30 530 260 530 950
preplace netloc axi_gpio_0_GPIO 1 4 1 N 390
preplace netloc axi_smc_M00_AXI 1 3 1 1280 80n
preplace netloc axi_smc_M01_AXI 1 3 1 N 100
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 2 1 960 60n
levelinfo -pg 1 0 130 600 1140 1430 1560
pagesize -pg 1 -db -bbox -sgen 0 0 1860 540
"
}
  ...
  set_property PFM_NAME {vendor:lib:myplatform:1.0} [get_files [current_bd_design].bd]
  set_property PFM.AXI_PORT {S_AXI_HP0_FPD { memport "S_AXI_HP" sptag "" memory "" is_range "false" } S_AXI_HP1_FPD { memport "S_AXI_HP" sptag "" memory "" is_range "false" } S_AXI_HP2_FPD { memport "S_AXI_HP" sptag "" memory "" is_range "false" } S_AXI_HP3_FPD { memport "S_AXI_HP" sptag "" memory "" is_range "false" } S_AXI_HPC0_FPD { memport "S_AXI_HPC" sptag "" memory "" is_range "false" } S_AXI_HPC1_FPD { memport "S_AXI_HPC" sptag "" memory "" is_range "false" } } [get_bd_cells /zynq_ultra_ps_e_0]
  set_property PFM.CLOCK {clk_out1 {id "6" is_default "true" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "100000000"}} [get_bd_cells /clk_wiz_0]
...
cr_bd_design_1 ""
set_property PFM_NAME "vendor:lib:myplatform:1.0" [get_files design_1.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_1.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project_1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
reset_run synth_1
if { [catch {launch_runs synth_1 -jobs 2}] } {
    puts "*** ERROR please check syn/syn.runs/synth_1/runme.log"
    puts $errorInfo
    exit 1
}

if { [catch {launch_runs impl_1 -to_step write_bitstream -jobs 2}] } {
    puts "*** ERROR please check syn/syn.runs/impl_1/runme.log"
    puts $errorInfo
    exit 1
}
...
# Report IOB utilization
report_datasheet -file util_iob.txt

# Report design utilization
report_utilization -hierarchical  -file util_hier.txt

# Export xsa
update_compile_order -fileset sources_1
set_property pfm_name {vendor:lib:myplatform:1.0} [get_files -all "$DIR_PETALINUX_COMMON/Kria_KR260_boardaware3/syn/syn.srcs/sources_1/bd/design_1/design_1.bd"]
set_property platform.uses_pr {false} [current_project]
write_hw_platform -hw -include_bit -force -file design_1_wrapper.xsa
