...
HD_PWD='/home/randy/projects/Kria_KR260/Kria_KR260.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_bd_wrapper.tcl
