...
HD_PWD='/home/randy/projects/Kria_KR260/Kria_KR260.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kria_bd_wrapper.tcl -notrace
