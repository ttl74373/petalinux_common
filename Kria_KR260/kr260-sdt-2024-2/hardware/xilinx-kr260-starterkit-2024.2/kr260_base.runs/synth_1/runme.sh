...
HD_PWD='/scratch/jenkins-BUILDS-hw_designs_builds-2024.2_amd-yocto-hw-platforms-95_kr260_base/kria_base/k26/kr260_base/hw_project/kr260_base/kr260_base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kria_starter_kit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kria_starter_kit_wrapper.tcl
